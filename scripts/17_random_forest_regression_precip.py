"""
랜덤포레스트로 다음날 강수량(precip_tomorrow)을 예측한다.
16과 같은 입력 변수·같은 분할을 써서 선형회귀와 나란히 비교할 수 있게 한다.
...
if __name__ == "__main__":
    ...
    metrics.to_csv(OUTPUT_DIR / "rf_regression_precip_metrics.csv", index=False)
    importances.to_csv(OUTPUT_DIR / "rf_regression_precip_importances.csv", index=False)
